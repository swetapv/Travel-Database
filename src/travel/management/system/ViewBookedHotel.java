...
public class ViewBookedHotel extends JFrame {
	...
	public ViewBookedHotel(String username)  {
		...
		JLabel lblName = new JLabel("VIEW BOOKED DETAILS");
		...
		JLabel lblGender = new JLabel("Bonfire :");
		...
		contentPane.add(l10);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from bookaccom where username = '"+username+"'");
                    while(rs.next()){
