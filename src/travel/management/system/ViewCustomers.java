...
public class ViewCustomers extends JFrame {
	...
	public ViewCustomers() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                Image i3 = i1.getImage().getScaledInstance(626, 180,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(0,450,626,150);
                add(l1);
		...
		lblAvailability.setBounds(50, 25, 100, 50);
		contentPane.add(lblAvailability);
		
		lblCleanStatus = new JLabel("Id Type");
		lblCleanStatus.setBounds(50, 105, 100, 50);
		contentPane.add(lblCleanStatus);
		
		lblNewLabel = new JLabel("Number");
		lblNewLabel.setBounds(50, 185, 100, 50);
		contentPane.add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("Name");
		lblNewLabel_1.setBounds(50, 265, 100, 50);
		contentPane.add(lblNewLabel_1);

		
		lblId = new JLabel("Gender");
		lblId.setBounds(50, 345, 100, 50);
		contentPane.add(lblId);
                
                JLabel l3 = new JLabel("Country");
		l3.setBounds(470, 28, 100, 50);
		contentPane.add(l3);
                
                JLabel l4 = new JLabel("Address");
		l4.setBounds(470, 108, 100, 50);
		contentPane.add(l4);
                
                JLabel l5 = new JLabel("Phone");
		l5.setBounds(470, 188, 100, 50);
		contentPane.add(l5);
                
                JLabel l6 = new JLabel("Email");
		l6.setBounds(470, 268, 100, 50);
		contentPane.add(l6);
