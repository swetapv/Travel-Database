...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/house.jpg"));
		...
		JLabel lblName = new JLabel("BOOK ACCOMMODATION");
		...
		contentPane.add(l1);
                ...
                JLabel lblId = new JLabel("Select Type :");
		...
		contentPane.add(lblId);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from accom");
                    while(rs.next()){
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "select * from accom where name = '"+c1.getSelectedItem()+"'";
                                ResultSet rs = c.s.executeQuery(q1);
                                if(rs.next()){
                                    
                                    int cost = Integer.parseInt(rs.getString("costperperson"));
                                    int food = Integer.parseInt(rs.getString("foodincluded"));
                                    int ac = Integer.parseInt(rs.getString("bonfire"));
                                    ...
                                    if(persons * days > 0) {
                                        int total = 0;
                                        total += acprice.equals("Bonfire") ? ac : 1;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookaccom values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
                                c.s.executeUpdate(q1);
                                
	    			JOptionPane.showMessageDialog(null, "Accommodation Booked Successfully");
                                setVisible(false);
                            }catch(Exception ee){
	    			System.out.println(ee.getMessage());
                            }
