...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		contentPane.add(l1);
                ...
                JLabel lblsd = new JLabel("Select Destinations :");
		lblsd.setBounds(35, 110, 200, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookPackage values('"+username+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', "
		...
		btnNewButton.setBounds(200, 390, 120, 30);
		...
		btnExit.setBounds(350, 390, 120, 30);
