...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"paint.jpg","GOLD PACKAGE","Rocket Ejector", "Giant Swing", "Tree Climbing", "Kayaking", "Bubble Soccer", "Human Foosball", "Buffet Lunch", "BOOK NOW", "Inclusive Tax", "Rs 2600/- only"};
      String[] package2 = new String[]{"foos.jpg","SILVER PACKAGE","Giant Swing", "Kayaking", "Archery Tag", "Human Foosball", "Night Safari", "Bubble Soccer", "Buffet Lunch", "BOOK NOW", "Inclusive Tax", "Rs 1650/- only"};
      String[] package3 = new String[]{"skyswing.jpg","BRONZE PACKAGE","Kayaking", "Archery Tag", "Bubble Soccer", "Human Foosball", "Sky Swing", "Hi Tea", "Buffet Lunch", "BOOK NOW", "Inclusive Tax", "Rs 1450/- only"};
